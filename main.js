...
document.getElementById('form-reseña').addEventListener('submit', function(event) {
	...
	var reseñaContainer = document.getElementById('reseñas-container');
	var nuevaReseña = document.createElement('div');
	nuevaReseña.classList.add('reseña');
	nuevaReseña.innerHTML = `
	  <img src="usuario-nuevo.jpg" alt="Foto Nuevo Usuario" class="foto-usuario">
	...
	`;
	reseñaContainer.appendChild(nuevaReseña);
